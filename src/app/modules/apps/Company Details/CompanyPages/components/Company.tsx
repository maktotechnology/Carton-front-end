    ...
    <>
      <div className='card mb-5 mb-xl-10' id='kt_profile_details_view'>
        <div className='card-header cursor-pointer'>
          ...
          <Link to={`/Company/details/settings/${userID}`} className='btn btn-primary align-self-center'>
            Edit Company
          </Link>
        </div>
        ...
        <div className='card-body p-9'>
          <div className='row mb-7'>
            ...
            <div className='col-lg-8'>
              <span className='fw-bolder fs-6 text-gray-900'>{`${userData?.company_name || ''} ${userData?.lastname || ''}`}</span>
            </div>
          </div>
