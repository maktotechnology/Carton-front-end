...
const ProfileDetails: React.FC = () => {
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      const userDocRef = doc(db, 'delivery', userID);
  ...
  return (
    <div className='card mb-5 mb-xl-10'>
      ...
      <div className='card-body border-top p-9'>
        ...
        {/* Rider ID */}
        <div className='row mb-6'>
          <label className='col-lg-4 col-form-label fw-bold fs-6'>Rider ID</label>
          <div className='col-lg-8'>
            <input
              type='text'
              name='riderid'
        ...
        {/* Vechicle Number */}
        <div className='row mb-6'>
          <label className='col-lg-4 col-form-label fw-bold fs-6'>Vechicle Number</label>
          <div className='col-lg-8'>
            <input
              type='text'
              name='vechicelnumber'
        ...
        {/* Vechicle Type */}
        <div className='row mb-6'>
          <label className='col-lg-4 col-form-label fw-bold fs-6'>Vechicle Type</label>
          <div className='col-lg-8'>
            <input
              type='text'
              name='vechiceltype'
