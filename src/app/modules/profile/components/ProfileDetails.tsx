...
const ProfileDetails: React.FC = () => {
    ...
    const fetchUserDetails = async () => {
        ...
        try {
          ...
          if (!querySnapshot.empty) {
            ...
            const user = { id: userDocSnapshot.id, ...userDocSnapshot.data() }; // Include the document ID
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      const userDocRef = doc(db, 'user', userData.id); // Use the document ID stored in userData
